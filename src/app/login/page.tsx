...
const ERROR_MESSAGES: Record<string, string> = {
  unauthorized: "Tu email no tiene acceso a este dashboard.",
  cancelled: "Inicio de sesión cancelado.",
  google: "Error al comunicarse con Google. Intentá de nuevo.",
  invalid: "Solicitud inválida. Intentá de nuevo.",
    ...
    <div className="min-h-screen flex items-center justify-center bg-bg-main px-4">
      <div className="w-full max-w-sm">
        ...
        <div className="card space-y-4">
          ...
          <a
            href="/api/auth/login"
            className="flex items-center justify-center gap-3 w-full bg-white border border-card-border py-2.5 rounded-lg font-medium hover:bg-gray-50 transition-colors text-gray-700"
          >
